...
<div class="container-fluid py-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card border-0 text-white bg-dark p-4 h-100 shadow-sm" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%);">
                <h5 class="fw-bold mb-3"><i class="bi bi-lightbulb me-2 text-warning"></i> Admin Tips</h5>
